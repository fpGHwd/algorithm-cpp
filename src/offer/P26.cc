...
int main(int argc, char **argv){
    BinaryTreeNode *n1 = nullptr, *n2= nullptr;
    printf("%d",HasSubstree(n1,n2));
    return 0;
}

bool Equal(BinaryTreeNode* n1, BinaryTreeNode* n2);
bool DoesTree1HaveTree2(BinaryTreeNode* n1, BinaryTreeNode* n2);
...
bool DoesTreeHaveTree2(BinaryTreeNode*n1, BinaryTreeNode*n2){
